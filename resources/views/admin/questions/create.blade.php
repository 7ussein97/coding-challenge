    ...
    <div class="col-lg-8">
        <div class="card stat-card">
            <div class="card-header bg-white border-bottom py-3 px-4">
                <h6 class="fw-bold mb-0"><i class="fas fa-plus me-2 text-warning"></i>New Question</h6>
            </div>
                ...
                <form action="{{ route('admin.questions.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                   value="{{ old('title') }}" placeholder="e.g. Two Sum">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="10"
                                      ...
                                      placeholder="Enter the full problem statement here..." required>{{ old('description') }}</textarea>
                            @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-semibold">
                                Question Image <span class="text-muted fw-normal">(optional — JPG/PNG, max 4MB)</span>
                            </label>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-warning text-dark">
                            <i class="fas fa-check me-1"></i>Create Question
                        </button>
